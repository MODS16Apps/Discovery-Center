...
public class ColorDialogFragment extends DialogFragment {
    ...
    private DrawingFragment getDoodleFragment() {
        return (DrawingFragment) getFragmentManager().findFragmentById(
                R.id.doodleFragment);
    }
    ...
    public void onAttach(Activity activity) {
        ...
        DrawingFragment fragment = getDoodleFragment();
